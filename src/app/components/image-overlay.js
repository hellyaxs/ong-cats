  ...
  <div   style={{msOverflowX:'hidden', position: 'relative', width: '100%', height: '700px' }}>
      ...
      <div 
       style={{ position: 'absolute', top: '51%', left: '23%', transform: 'translate(-50%, -50%)' }}>
        ...
        <button class="flex ml-11 items-center py-8 px-16 font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-blue-600 rounded-lg hover:bg-blue-500 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-80">
