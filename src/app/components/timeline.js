...
export default function Timeline() {
    ...
    <session>
        ...
        <h2 class="font-sf-new-republic mb-4 text-4xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-6xl dark:text-black">
            Conheça a ONG TinieBird Cats</h2>
        <p class="font-sf-new-republic mb-6 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-96 dark:text-gray-400">
        ...
        <div class="flex w-full">
          ...
          <div class="max-w-6xl mx-auto px-4 md:px-6 ">
                ...
                <div class="relative flex items-center justify-between md:justify-normal md:even:flex-row-reverse group is-active"> 
                        ...
                        <div class="relative flex items-center justify-between md:justify-normal md:even:flex-row-reverse group is-active">
                            ...
                            <div class="w-[calc(100%-3rem)] md:w-[calc(50%-2.5rem)] p-4  ">
                                ...
                                <div class="mx-4 text-slate-500">Pretium lectus quam id s risus.</div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <button class="flex ml-11 my-12 items-center px-10 py-4 font-medium tracking-wide text-white transition-colors duration-300 transform bg-blue-350 rounded-sm hover:bg-blue-500 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-80">
