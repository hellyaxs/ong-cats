...
export default function Timeline() {
  return (
    <section>
      <div class="px-3 py-20 mx-auto text-center justify-center items-center">
        <h3 class="font-sf-new-republic mb-4 font-medium leading-none tracking-tight text-gray-900 md:text-3xl lg:text-3xl dark:text-black">
          Conheça a ONG TinieBird Cats
        </h3>
        <p class="font-sf-new-republic mb-6 text-xs text-gray-500 lg:text-xl sm:px-16 xl:px-64 dark:text-gray-400">
          Existem muitos <strong>gatos a espera de um lar</strong>
          e com muito amor para oferecer. Nós fazemos essa ponte <br />
          para que você adote um amigo e faça a diferença na vida de um animal
          carente.
        </p>
      </div>
            ...
            <div class="w-full max-w-3xl mx-auto">
              <div class="relative before:absolute before:inset-0 before:ml-5 before:-translate-x-px md:before:mx-auto md:before:translate-x-0 before:h-full before:w-0.5 before:bg-gradient-to-b before:from-transparent before:via-rose-250 before:to-transparent">
                <div class="relative flex items-center justify-between md:justify-normal md:even:flex-row-reverse group is-active">
                  <div class="flex items-center justify-center w-10 h-10 rounded-full border border-white bg-slate-300 group-[.is-active]:bg-rose-250 text-rose-500 group-[.is-active]:text-emerald-50 shadow shrink-0 md:order-1 md:group-odd:-translate-x-1/2 md:group-even:translate-x-1/2">
                    <svg
                      width="14"
                      height="14"
                      viewBox="0 0 15 14"
                ...
                <div class="relative flex items-center justify-between md:justify-normal md:even:flex-row-reverse group is-active">
                  ...
                  <div class="w-[calc(100%-3rem)] md:w-[calc(50%-2.5rem)] p-4  ">
                    <div class="flex items-center justify-between mx-4 space-x-2 mb-1">
                      <div class="text-3xl font-bold text-slate-900">2023</div>
                      <time class="text-xs font-medium text-rose-250"></time>
                    </div>
                    <div class="mx-4 text-slate-500">
                      Pretium lectus quam id s risus.
                    </div>
                  </div>
                </div>
