  ...
  return (
   ...
   <header className="container mx-auto py-4 flex flex-col font-roboto">
        ...
        <nav className="flex justify-center items-center ">
         <div className="w-full xl:justify-center flex ">  
          ...
          <div class="flex lg:hidden">
                <button x-cloak type="button" class=" dark:text-gray-200 hover:text-gray-600 dark:hover:text-gray-400 focus:outline-none focus:text-gray-600 dark:focus:text-gray-400" aria-label="toggle menu">
                    <svg x-show="!isOpen" xmlns="http://www.w3.org/2000/svg" class="w-12 h-12" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
